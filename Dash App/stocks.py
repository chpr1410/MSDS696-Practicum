...
#file = pathlib.Path.cwd() / 'data'/ file_name
model_result_df = pd.read_csv(file_name)
...
#def update_graph(n_clicks, stock_ticker, metric, day, hour):
def update_graph(n_clicks, stock_ticker, day, hour, n_clicks2, stock_ticker2, day2, hour2, n_clicks3, chosen_rows):
